...
import { totalCharacters } from "./codeTable.js";
...
class State {
  ...
  incrementCodePosition(increment = 1) {
    if ((this.#currentCodeIndex + increment) >= this.#testCharCodeLength) {
      this.#practiceIndex = saveSetting('practiceIndex', (this.#practiceIndex + 1) % totalCharacters, false);
      return 0; // user has finished practicing this character, no increment
    }
